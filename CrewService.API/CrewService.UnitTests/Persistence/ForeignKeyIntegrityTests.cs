...
public class ForeignKeyIntegrityTests
{
    ...
    public void NoCtrlNbrProperty_IsOrphanedWithoutForeignKey()
    {
        ...
        var polymorphicExclusions = new HashSet<(string Entity, string Property)>
        {
            ...
            // Error log — diagnostic scope tags are denormalized capture context, not relational FKs
            ("ErrorLog", "ParentCtrlNbr"),
            ("ErrorLog", "RailroadCtrlNbr"),
    ...
    [InlineData("AbsenceStartRecord", "AbsenceRequest", DeleteBehavior.Cascade)]
    [InlineData("AbsenceEndRecord", "AbsenceRequest", DeleteBehavior.Cascade)]
    ...
    [InlineData("RosterBoard", "Roster", DeleteBehavior.Cascade)]
    [InlineData("Seniority", "Roster", DeleteBehavior.Cascade)]
    ...
    [InlineData("Craft", "Department", DeleteBehavior.Cascade)]
    [InlineData("Roster", "Craft", DeleteBehavior.Cascade)]
    [InlineData("CraftRole", "Craft", DeleteBehavior.Cascade)]
    [InlineData("CallSheetRule", "Department", DeleteBehavior.Cascade)]
    [InlineData("DepartmentReassignmentRule", "Department", DeleteBehavior.Cascade)]
    [InlineData("HolidayQualificationRule", "Craft", DeleteBehavior.Cascade)]
    [InlineData("DisplacementCase", "Craft", DeleteBehavior.Cascade)]
    ...
    [InlineData("RosterBoard", "Craft", DeleteBehavior.Restrict)]
