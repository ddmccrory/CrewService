...
public sealed class Permission : Entity
{
    ...
    private Permission(ControlNumber roleCtrlNbr, ControlNumber featureCtrlNbr, AccessLevel accessLevel, ControlNumber? parentCtrlNbr, ControlNumber? craftCtrlNbr)
    {
    ...
    public static Permission Create(ControlNumber roleCtrlNbr, ControlNumber featureCtrlNbr, AccessLevel accessLevel, ControlNumber? parentCtrlNbr = null, ControlNumber? craftCtrlNbr = null)
    {
