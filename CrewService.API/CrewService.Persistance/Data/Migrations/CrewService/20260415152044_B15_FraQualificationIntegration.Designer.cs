...
namespace CrewService.Persistance.Data.Migrations.CrewService
{
    ...
    [Migration("20260415152044_B15_FraQualificationIntegration")]
    partial class B15_FraQualificationIntegration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CrewService.Domain.Modules.Employees.QualificationEvidence", b =>
                {
                    ...
                    b.Property<long?>("PrerequisiteCtrlNbr")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PrerequisiteCtrlNbr");

                    b.ToTable("QualificationEvidence");
                });

            modelBuilder.Entity("CrewService.Domain.Modules.Employees.QualificationPrerequisite", b =>
                {
                    b.Property<long>("CtrlNbr")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("PrerequisiteKind")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("QualificationPrerequisites");
                });
            ...
            modelBuilder.Entity("CrewService.Domain.Modules.Employees.QualificationEvidence", b =>
                {
                    ...
                    b.HasOne("CrewService.Domain.Modules.Employees.QualificationPrerequisite", null)
                        .WithMany()
                        .HasForeignKey("PrerequisiteCtrlNbr")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CrewService.Domain.Modules.Employees.QualificationPrerequisite", b =>
                {
                    ...
                    b.OwnsOne("CrewService.Domain.ValueObjects.AuditStamp", "CreatedBy", b1 =>
                        {
                            b1.Property<long>("QualificationPrerequisiteCtrlNbr")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("QualificationPrerequisiteCtrlNbr");

                            b1.ToTable("QualificationPrerequisites");

                            b1.WithOwner()
                                .HasForeignKey("QualificationPrerequisiteCtrlNbr");
                        });
