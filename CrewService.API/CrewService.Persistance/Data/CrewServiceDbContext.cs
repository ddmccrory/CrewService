...
IFieldEncryptor fieldEncryptor) : DbContext(options), IOutboxDbContext
{
    ...
    public DbSet<Domain.Modules.FraCompliance.FraCertificationConfig> FraCertificationConfigs => Set<Domain.Modules.FraCompliance.FraCertificationConfig>();
    public DbSet<Domain.Modules.FraCompliance.FraCertificationCheckConfig> FraCertificationCheckConfigs => Set<Domain.Modules.FraCompliance.FraCertificationCheckConfig>();
