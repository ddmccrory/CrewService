...
internal class EarningCodeRuleConfiguration : IEntityTypeConfiguration<EarningCodeRule>
{
    public void Configure(EntityTypeBuilder<EarningCodeRule> builder)
    {
        ...
        builder.Property(r => r.ConditionsJson).HasMaxLength(2000).IsRequired();
        builder.Property(r => r.ResultCode).HasMaxLength(20).IsRequired();
