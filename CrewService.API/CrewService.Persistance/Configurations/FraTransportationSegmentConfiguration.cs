...
internal class FraTransportationSegmentConfiguration : IEntityTypeConfiguration<FraTransportationSegment>
{
    public void Configure(EntityTypeBuilder<FraTransportationSegment> builder)
    {
        ...
        builder.Property(s => s.TransportMode).HasMaxLength(50).IsRequired();
