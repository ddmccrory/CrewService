...
internal class RailroadPoolEmployeeConfiguration : IEntityTypeConfiguration<RailroadPoolEmployee>
{
    public void Configure(EntityTypeBuilder<RailroadPoolEmployee> builder)
    {
        ...
        builder.Property(e => e.RailroadPoolCtrlNbr).HasConversion(
            ctrlNbr => ctrlNbr.Value,
            value => ControlNumber.Create(value));
