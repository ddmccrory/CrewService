...
internal class CraftCallSheetRuleConfiguration : IEntityTypeConfiguration<CraftCallSheetRule>
{
    public void Configure(EntityTypeBuilder<CraftCallSheetRule> builder)
    {
        builder.HasKey(r => r.CtrlNbr);
        builder.Property(r => r.CtrlNbr).HasConversion(c => c.Value, v => ControlNumber.Create(v));
        ...
        builder.Property(r => r.IsEnabled).IsRequired();
        builder.Property(r => r.PreOnDutyChangeCutoffMinutes).IsRequired();
